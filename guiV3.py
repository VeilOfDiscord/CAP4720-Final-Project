...
class Button:
    def __init__(self, root, label_text, currency):
        self.root = root
        self.label = tk.Label(self.root, text=label_text)
        self.label.pack(padx=10, pady=5, anchor="w")
        self.color_button = tk.Button(self.root, text=currency)
        self.color_button.pack()
...
class SimpleGUI:
    ...
    def add_button(self, label_text, currency):
        button = Button(self.root, label_text, currency)
        return button
...
if __name__ == '__main__':
    ...
    button = gui.add_button(label_text="Test Button", currency=123)
